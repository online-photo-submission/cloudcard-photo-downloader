...
class CSVManifestFileServiceSpec extends Specification {
    ...
    def "test resolveValue returns #expectedResult for #description"() {
        ...
        "nested property"       | "person.email"                  | new Photo(id: 1, person: new Person(identifier: "123", email: "test@example.com"), bytes: null, externalURL: "file.jpg")                                                         | null                                                                     | "test@example.com"
        "non-existent property" | "person.nonExistentProperty"    | new Photo(id: 1, person: new Person(identifier: "123", email: "test@example.com"), bytes: null, externalURL: "file.jpg")                                                         | null                                                                     | null
        "date property"         | "dateCreated"                   | new Photo(id: 1, person: new Person(identifier: "123", email: "test@example.com"), bytes: null, externalURL: "file.jpg", dateCreated: parseDate("Fri Feb 16 11:41:44 EST 2024")) | null                                                                     | "2024-02-16"
        "custom Field property" | "person.customFields.Full Name" | new Photo(id: 1, person: new Person(identifier: "123", email: "test@example.com", customFields: ["Full Name": "James"]), bytes: null, externalURL: "file.jpg")                   | null                                                                     | "James"
        "photo full file path"  | "photo_fullFilePath"            | new Photo(id: 1, person: new Person(identifier: "123", email: "test@example.com"), bytes: null, externalURL: "file.jpg")                                                         | new PhotoFile("photo1", "/Users/Calvin/downloaded-photos/photo1.jpg", 1) | "/Users/Calvin/downloaded-photos/photo1.jpg"
        "photo custom path"     | "photo_customFilePath"          | new Photo(id: 1, person: new Person(identifier: "123", email: "test@example.com"), bytes: null, externalURL: "file.jpg")                                                         | new PhotoFile("photo2", "photo2.jpg", 1)                                 | "//random/nonsense/photo2.jpg"
        "photo custom path png" | "photo_customFilePath"          | new Photo(id: 1, person: new Person(identifier: "123", email: "test@example.com"), bytes: null, externalURL: "file.png")                                                         | new PhotoFile("photo2", "photo2.png", 1)                                 | "//random/nonsense/photo2.png"
        "photo file name"       | "photo_fileName"                | new Photo(id: 1, person: new Person(identifier: "123", email: "test@example.com"), bytes: null, externalURL: "file.jpg")                                                         | new PhotoFile("photo2", "photo2.jpg", 1)                                 | "photo2.jpg"
        "photo file name png"   | "photo_fileName"                | new Photo(id: 1, person: new Person(identifier: "123", email: "test@example.com"), bytes: null, externalURL: "file.png")                                                         | new PhotoFile("photo2", "photo2.png", 1)                                 | "photo2.png"
    }
