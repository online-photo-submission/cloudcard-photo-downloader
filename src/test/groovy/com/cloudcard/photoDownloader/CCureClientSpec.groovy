...
class CCureClientSpec extends Specification {
    ...
    void setup() {
        ...
        client = new CCureClient([
                apiUrl: appProps.getProperty("CCureClient.apiUrl"),
                operatorId: appProps.getProperty("CCureClient.operatorId"),
                operatorPassword: appProps.getProperty("CCureClient.operatorPassword"),
                clientName: appProps.getProperty("CCureClient.clientName"),
                clientId: appProps.getProperty("CCureClient.clientId"),
                compatibleCCureVersion: appProps.getProperty("CCureClient.compatibleCCureVersion"),
        ])
    }
    ...
    void "test all requests"() {
        expect:
        assert client.isOnline()
        client.operatorLogin()
