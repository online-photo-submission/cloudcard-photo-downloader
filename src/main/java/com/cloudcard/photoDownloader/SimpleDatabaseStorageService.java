...
@Service
@ConditionalOnProperty(value = "downloader.storageService", havingValue = "SimpleDatabaseStorageService")
//TODO: stop extending DatabaseStorageService - actually maybe this should be called DatabaseStorageService
